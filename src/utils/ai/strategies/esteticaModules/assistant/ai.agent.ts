...
export async function runEsteticaAgent(
    ...
    // 2) Si hay tool calls → ejecutar (con retry) y hacer follow-up
    if (Array.isArray(msg.tool_calls) && msg.tool_calls.length) {
        ...
        // 3) Segunda vuelta con resultados de tools
    ...
    const finalText = direct || "¿Quieres que te comparta horarios desde mañana o prefieres más información?";
