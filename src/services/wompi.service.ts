...
/* ============================================================
   4) Cobro con token (CARD) – AJUSTADO
   - Usa SOLO acceptance_token (sin accept_personal_auth)
============================================================ */
...
export async function chargeWithToken({
    ...
    // Usamos SOLO el acceptance_token principal
    const acceptance_token = await getAcceptanceToken();
    ...
    const body = {
        ...
        customer_email: customerEmail,
        reference,
        acceptance_token, // 👈 SOLO este campo
        payment_method: {
            type: "CARD",
            token,
            installments: 1,
...
/* ============================================================
   ...
   (lo dejamos por si más adelante ajustas al flujo oficial 3DS)
============================================================ */
