...
/* ============================================================
   5) ✨ NUEVO: Cobro con Payment Source (RECURRENTE)
   Usa el ID de la fuente (id numérico o src_) en lugar de token desechable
============================================================ */
...
export async function chargeWithPaymentSource({
    ...
    console.log("💸 [WOMPI] Iniciando cobro con Payment Source (RECURRENTE)...");
    console.log("   → payment_source_id:", paymentSourceId);
    console.log("   → amount_in_cents:", amount);
    console.log("   → reference:", reference);
    ...
    const body = {
        ...
        payment_method: {
            type: "CARD",
            payment_source_id: paymentSourceId, // 👈 Clave: Usamos ID de fuente
            installments: 1,
        },
        signature,
        acceptance_token,
